...
USAGE:
    python -m scripts.maintenance.clear_bi_specialist_memory              # clears 'bi-specialist'
    python -m scripts.maintenance.clear_bi_specialist_memory my-group     # clears a specific group
    python -m scripts.maintenance.clear_bi_specialist_memory --dry-run    # show target, delete nothing
"""
