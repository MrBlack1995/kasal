...
import re
from converters.base.models import KPI, Structure
        ...
        for kpi in definition.kpis:
            if kpi.apply_structures:
                ...
                combined_kbis = self._create_combined_measures(
                    kbi, definition.structures, kpi.apply_structures, definition
                )
            ...
            if kpi.apply_structures:
                for struct_name in kpi.apply_structures:
                    if struct_name not in definition.structures:
                        errors.append(f"KBI '{kbi.technical_name or kpi.description}' references undefined structure: {struct_name}")
