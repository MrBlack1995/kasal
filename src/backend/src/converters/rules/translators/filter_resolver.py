...
from converters.models.kbi import KBIDefinition, KBI, QueryFilter
...
class FilterResolver:
    ...
    def resolve_filters(self, definition: KBIDefinition, kbi: KBI) -> List[str]:
        """Resolve all filters for a KBI, replacing variables and query filter references."""
        resolved_filters = []
        
        for filter_item in kbi.filters:
    ...
    def _resolve_complex_filter(self, filter_dict: Dict[str, Any], definition: KBIDefinition) -> str:
