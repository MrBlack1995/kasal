...
class DependencyResolver:
    ...
    def __init__(self):
        self.measure_registry: Dict[str, KBI] = {}
        self.dependency_graph: Dict[str, List[str]] = defaultdict(list)
        self.resolved_cache: Dict[str, str] = {}
        
    def register_measures(self, definition: KBIDefinition):
        """Register all measures from a KBI definition for dependency resolution"""
        ...
        for kbi in definition.kbis:
            if kbi.technical_name:
                self.measure_registry[kbi.technical_name] = kbi
        
        # Build dependency graph
        for kbi in definition.kbis:
            if kbi.technical_name:
                dependencies = self._extract_measure_references(kbi.formula)
                self.dependency_graph[kbi.technical_name] = dependencies
    ...
    def _generate_leaf_measure_dax(self, measure: KBI) -> str:
        ...
        # Create KBI definition dict for the aggregation system
        kbi_dict = {
            'formula': measure.formula,
