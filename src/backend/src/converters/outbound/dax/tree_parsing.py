...
from converters.base.models import KPI, KPIDefinition, DAXMeasure
...
class TreeParsingDAXGenerator(DAXGenerator):
    ...
    def kpi: KPI) -> DAXMeasure:
        ...
        dax_formula = self._add_filters_to_dax(resolved_formula, resolved_filters, kpi.source_table or 'Table', kbi)
        ...
        elif hasattr(kbi, 'display_sign') and kpi.display_sign != 1:
    ...
    def get_dependency_analysis(self, definition: KPIDefinition) -> Dict:
        ...
        for kpi in definition.kpis:
            if kpi.technical_name:
                analysis["measure_trees"][kbi.technical_name] = self.dependency_resolver.get_dependency_tree(kpi.technical_name)
        
        return analysis
    
    def generate_measure_with_separate_dependencies(self, definition: KPIDefinition, target_measure_name: str) -> List[DAXMeasure]:
        """
        ...
        for measure_name in required_measures:
            ...
            if kpi.aggregation_type == 'CALCULATED' and measure_name != target_measure_name:
    ...
    def get_measure_complexity_report(self, definition: KPIDefinition) -> Dict:
        ...
        for kpi in definition.kpis:
            if kpi.technical_name:
                ...
                measure_info = {
                    ...
                    "direct_dependencies": len(self.dependency_resolver.dependency_graph.get(kpi.technical_name, [])),
