"""Recover JSON from LLM output without database or service dependencies.

This parser repairs malformed/truncated responses and accepts dictionaries and
arrays. Keep it distinct from json_extraction.extract_json_dict, whose contract
is to extract a valid dictionary or return None without structural repair.
"""
