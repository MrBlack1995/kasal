"""
Measure Conversion Service

Business logic layer for measure conversion operations.
Orchestrates conversion between different measure formats using the converters package.
"""
...
from src.schemas.measure_conversion import (
    ConversionRequest,
    ConversionResponse,
    ConversionPath,
...
class MeasureConversionService:
    """
    Service for handling measure conversion operations.

    Provides high-level business logic for:
    - Converting measures between formats (YAML, DAX, SQL, UC Metrics, PBI)
    - Validating measure definitions
    - Batch conversion operations
    - Format discovery and capability queries
    """

    def __init__(self):
        """Initialize the measure conversion service."""
    ...
    async def convert(
        ...
        """
        Convert measures from source format to target format.
    ...
    async def validate(
        ...
        """
        Validate measure definition for a specific format.
    ...
    async def batch_convert(
        ...
        """
        Convert multiple measures in a batch operation.
