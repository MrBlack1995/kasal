"""Shared output directives for Chat and crew/flow task execution.

App-owned deliverables use structured content for A2UI; diagrams and decks use
sandboxed HTML. Keep this policy common to all three execution paths.
"""
