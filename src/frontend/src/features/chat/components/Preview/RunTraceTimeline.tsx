...
import { isEventClickable } from '../../../executions/trace/lib/traceEventProcessors';
import { formatTraceDuration, formatTraceOffset, parseTraceTime } from '../../../executions/trace/lib/processTraces';
import type {
  GroupedTrace,
  ProcessedTraces,
  TraceEvent,
