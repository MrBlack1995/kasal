...
vi.mock('../../../tools/components/configuration/GenieSpaceSelector', () => ({
  GenieSpaceSelector: () => <div />,
}));
vi.mock('../../../tools/components/configuration/PerplexityConfigSelector', () => ({
  PerplexityConfigSelector: () => <div />,
}));
vi.mock('../../../tools/components/configuration/SerperConfigSelector', () => ({
  SerperConfigSelector: () => <div />,
}));
vi.mock('../../../tools/components/configuration/MCPServerSelector', () => ({
  MCPServerSelector: () => <div />,
}));
vi.mock('../../../help/best-practices/AgentBestPractices', () => ({
  default: () => <div />,
}));
